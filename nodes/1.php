...
<div class="col-md-12 bg-1 mt-2">
  <h5>Web Consultant</h5>
  <p>If your a business seeking a web-based solution or an employer looking to discuss an oppurtunity, feel free to <a href="<?php echo $instance->href("contact.html");?>">send a message</a>.</p>
</div>
