...
<p>This function came in very useful - it enabled the reporting of daily production rates. Previously, the client was unable to determine output accurately. Here is what that looks like in Fanuc code:</p><pre><code class="language-fanuc">
   1:  !================================;
   2:  ! WARNING: DO NOT MODIFY.;
