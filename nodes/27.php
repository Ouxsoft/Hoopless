...
echo '<h2>Code</h2>';
echo '<p>Although the actual solution consisted of numerous functions and other routines, below is basically what that the warp offset looked like in code</p>';
echo '<pre><code class="language-fanuc">'?>
   1:  !================================;
