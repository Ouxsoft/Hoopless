...
echo "<h1><img src=\"{$instance->href("img/common/logo-big.png")}\" alt=\"Matt Heroux\"/><span class=\"normal\"> / <abbr title=\"also known as Mr. Heroux\">Mr. Heroux</abbr></span></h1>";
...
echo "<li>maintain college web services;</li>";
echo "<li>et al.</li>";
echo "</ul>";
echo "<p>If you are a business seeking a web-based solution or an employer looking to hire, feel free to get in touch with me.</p>";
